...
export const RokariComics: PageInterface = {
  name: 'RokariComics',
  domain: 'https://rokaricomics.com',
  languages: ['English'],
  type: 'manga',
  urls: {
    match: ['*://rokaricomics.com/*'],
  },
  search: 'https://rokaricomics.com/?s={searchtermPlus}',
  sync: {
    isSyncPage($c) {
      return $c
        .and(
  ...
  overview: {
    ...
    uiInjection($c) {
      return $c.querySelector('.seriestucontr').uiAfter().run();
    },
  },
  list: {
    elementsSelector($c) {
