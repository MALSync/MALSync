...
export const batoV2: PageInterface = {
  ...
  type: 'manga',
  urls: {
    match: ['*://bato.to/*', '*://bato.ac/*', '*://bato.bz/*', '*://bato.cc/*', '*://bato.cx/*', '*://bato.id/*', '*://bato.pw/*', '*://bato.sh/*', '*://bato.vc/*', '*://bato.day/*', '*://bato.red/*', '*://bato.run/*', '*://ato.to/*', '*://lto.to/*', '*://nto.to/*', '*://vto.to/*', '*://xto.to/*', '*://yto.to/*', '*://vba.to/*', '*://wba.to/*', '*://xba.to/*', '*://yba.to/*', '*://zba.to/*', '*://kuku.to/*', '*://okok.to/*', '*://ruru.to/*', '*://xdxd.to/*', '*://batoto.in/*', '*://batoto.tv/*', '*://batpub.com/*', '*://batread.com/*', '*://fto.to/*', '*://jto.to/*', '*://hto.to/*', '*://zbato.com/*', '*://zbato.net/*', '*://zbato.org/*', '*://readtoto.com/*', '*://readtoto.net/*', '*://readtoto.org/*', '*://batocomic.com/*', '*://batocomic.net/*', '*://batocomic.org/*', '*://batotoo.com/*', '*://batotwo.com/*', '*://comiko.net/*', '*://comiko.org/*', '*://battwo.com/*', '*://dto.to/*', '*://mto.to/*', '*://wto.to/*', '*://xbato.com/*', '*://xbato.net/*', '*://xbato.org/*', '*://mangatoto.com/*', '*://mangatoto.net/*', '*://mangatoto.org/*'],
  },
