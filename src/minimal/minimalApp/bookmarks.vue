  ...
  <div>
    <div class="mdl-grid" id="malList" style="justify-content: space-around;">
      ...
      <div v-for="item in items" :key="item.id">
        <a :href="item.url" class="mdl-cell mdl-cell--2-col mdl-cell--4-col-tablet mdl-cell--6-col-phone mdl-shadow--2dp mdl-grid bookEntry" style="color: black; position: relative; cursor: pointer; height: 250px; padding: 0; width: 210px; height: 293px;">
