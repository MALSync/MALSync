<template>
  <div>
    ...
    <div class="mdl-grid">
      ...
      <a v-for="item in items" :key="item.id" class="mdl-cell bg-cell mdl-cell--6-col mdl-cell--8-col-tablet mdl-shadow--2dp mdl-grid searchItem" :href="item.url" style="cursor: pointer;">
