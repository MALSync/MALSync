      ...
      >
        ...
        <div class="mdl-cell mdl-cell--12-col">
          ...
          <div
            ...
            style="padding: 10px 0 0; overflow: visible"
          >
            <div
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            ...
            <li class="mdl-list__item" style="width: 100%">
              ...
              <input
                v-if="
                  !(renderObj && !renderObj.isOnList()) && typeof renderObj.delete !== 'undefined'
                "
                type="button"
...
export default {
  ...
  methods: {
    ...
    async render(renderObj) {
      ...
      activeLinks(renderObj.getType(), renderObj.getApiCacheKey(), renderObj.getTitle()).then(
        links => {
          if (!this.renderObj || stateTest !== this.renderObj.url) return;
          this.kiss2mal = links;
        },
