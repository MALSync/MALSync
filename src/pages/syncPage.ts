              ...
              message = `
                ...
                <div class="player-error" style="display: none; position: absolute; left: 0; right: 0; padding: 5px; bottom: 100%; color: rgb(255,64,129); background-color: #323232;">
                  ...
                  <div style="display: flex; justify-content: space-evenly">
                    <a class="player-error-missing-permissions" href="https://malsync.moe/pwa/#/settings/customDoamins" style="display: none; margin: 10px; border-bottom: 2px solid #e13f7b;">
