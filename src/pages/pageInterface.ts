export interface pageInterface {
    ...
    sync:{ //Defintions for the sync page
      ...
      getMalUrl?: (provider: 'MAL'|'ANILIST'|'KITSU'|'SIMKL') => Promise<string|false>, //(optional) Return the MALurl. Only really needs to be implemented if the page provides that info.
    },
    overview?:{
      getTitle: (url) => string,
