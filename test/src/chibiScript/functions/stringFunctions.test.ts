...
describe('String Functions', () => {
  describe('split', () => {
    it('should split string by delimiter', () => {
      ...
      expect(generateAndExecute(code)).to.deep.equal(['a', 'b', 'c']);
    });

    it('should handle empty string', () => {
      const code = $c.string('').split(',').run();
      expect(generateAndExecute(code)).to.deep.equal(['']);
    });
  });
  ...
  describe('join', () => {
    it('should join array with separator', () => {
      ...
      expect(generateAndExecute(code)).to.equal('a-b-c');
    });
  });
  ...
  describe('replace', () => {
    it('should replace first occurrence in string', () => {
      ...
      expect(generateAndExecute(code)).to.equal('orange apple');
    });

    it('should handle no matches', () => {
      const code = $c.string('apple').replace('banana', 'orange').run();
      expect(generateAndExecute(code)).to.equal('apple');
    });
  });
  ...
  describe('replaceAll', () => {
    it('should replace all occurrences in string', () => {
      ...
      expect(generateAndExecute(code)).to.equal('orange orange');
    });
  });
  ...
  describe('toLowerCase', () => {
    it('should convert to lowercase', () => {
      ...
      expect(generateAndExecute(code)).to.equal('hello world');
    });
  });
