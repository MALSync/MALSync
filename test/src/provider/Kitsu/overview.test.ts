...
describe('Kitsu overview', function() {
  ...
  let resObj = {
    ...
    "description": "<span style=\"white-space: pre-line;\">No Game No Life is a surreal comedy that follows Sora and Shiro, shut-in NEET siblings and the online gamer duo behind the legendary username \"Kuuhaku.\" They view the real world as just another lousy game; however, a strange e-mail challenging them to a chess match changes everything the brother and sister are plunged into an otherworldly realm where they meet Tet, the God of Games.\r\n\r\nThe mysterious god welcomes Sora and Shiro to Disboard, a world where all forms of conflict—from petty squabbles to the fate of whole countries—are settled not through war, but by way of high-stake games. This system works thanks to a fundamental rule wherein each party must wager something they deem to be of equal value to the other party's wager. In this strange land where the very idea of humanity is reduced to child’s play, the indifferent genius gamer duo of Sora and Shiro have finally found a real reason to keep playing games: to unite the sixteen races of Disboard, defeat Tet, and become the gods of this new, gaming-is-everything world.\r\n\r\n(Source: MAL Rewrite)</span>",
    ...
    "info": [
      ...
      {
        "title": "Genres:",
        "body": "<a href=\"https://kitsu.io/anime?categories=isekai\">Isekai</a>, <a href=\"https://kitsu.io/anime?categories=comedy\">Comedy</a>, <a href=\"https://kitsu.io/anime?categories=fantasy\">Fantasy</a>, <a href=\"https://kitsu.io/anime?categories=ecchi\">Ecchi</a>, <a href=\"https://kitsu.io/anime?categories=fantasy-world\">Fantasy World</a>, <a href=\"https://kitsu.io/anime?categories=parody\">Parody</a>"
      },
      {
        "title": "Rating:",
        "body": "PG"
